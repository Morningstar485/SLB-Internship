...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.checkBox_2.setText(QCoreApplication.translate("Dialog", u"Set speed RPM -500 and set Restrictor - 2000psi (3Strokes)", None))
        ...
        self.checkBox_3.setText(QCoreApplication.translate("Dialog", u"Set speed RPM -1000 and set Restrictor - 2000psi (3Strokes)", None))
        ...
        self.checkBox_4.setText(QCoreApplication.translate("Dialog", u"Set speed RPM -1500 and set Restrictor - 2000psi (3Strokes)", None))
        ...
        self.checkBox_5.setText(QCoreApplication.translate("Dialog", u"Set speed RPM -2000 and set Restrictor - 2000psi (3Strokes)", None))
...
from .Perform_MRPO_GS_4 import Perform_MRPO_GS_4

class Perform_MRPO_GS_3(QDialog):
    ...
    def next_step(self):
        # Collect all relevant user input directly into child_metadata for 2000 PSI
        ui = self.ui
        if self.child_metadata is None:
            self.child_metadata = {}
        self.child_metadata['rpm_500_checked_2000'] = ui.checkBox_2.isChecked()
        self.child_metadata['rpm_500_hpress_2000'] = ui.lineEdit_1.text()
        self.child_metadata['rpm_500_motor_current_2000'] = ui.lineEdit_2.text()
        self.child_metadata['rpm_500_stroke_time_2000'] = ui.lineEdit_3.text()
        self.child_metadata['rpm_1000_checked_2000'] = ui.checkBox_3.isChecked()
        self.child_metadata['rpm_1000_hpress_2000'] = ui.lineEdit_4.text()
        self.child_metadata['rpm_1000_motor_current_2000'] = ui.lineEdit_5.text()
        self.child_metadata['rpm_1000_stroke_time_2000'] = ui.lineEdit_6.text()
        self.child_metadata['rpm_1500_checked_2000'] = ui.checkBox_4.isChecked()
        self.child_metadata['rpm_1500_hpress_2000'] = ui.lineEdit_7.text()
        self.child_metadata['rpm_1500_motor_current_2000'] = ui.lineEdit_8.text()
        self.child_metadata['rpm_1500_stroke_time_2000'] = ui.lineEdit_9.text()
        self.child_metadata['rpm_2000_checked_2000'] = ui.checkBox_5.isChecked()
        self.child_metadata['rpm_2000_hpress_2000'] = ui.lineEdit_10.text()
        self.child_metadata['rpm_2000_motor_current_2000'] = ui.lineEdit_11.text()
        self.child_metadata['rpm_2000_stroke_time_2000'] = ui.lineEdit_12.text()

        dialog4 = Perform_MRPO_GS_4(self.child_metadata, self.admin_metadata)
