...
from .Perform_MRPO_GS_2_extra import Perform_MRPO_GS_2_extra

class Perform_MRPO_GS_2(QDialog):
    ...
    def next_step(self):
        ...
        dialog3 = Perform_MRPO_GS_2_extra(self.child_metadata, self.admin_metadata)
