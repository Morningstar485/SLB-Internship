...
from .Prepare_MRPC_3 import Prepare_MRPC_3
from .Prepare_MRPC_4 import Prepare_MRPC_4

class Prepare_MRPC_2(QDialog):
    ...
    def next_step(self):
        ...
        if self.ui.radioButton_1.isChecked():
            dialog = Prepare_MRPC_4(self.child_metadata, self.admin_metadata)
            if dialog.exec() == QDialog.Accepted:
                self.accept()  # ✅ Close this dialog and continue chain
        elif self.ui.radioButton_2.isChecked():
            dialog = Prepare_MRPC_3(self.child_metadata, self.admin_metadata)
            if dialog.exec() == QDialog.Accepted:
                self.accept()  # ✅ Close this dialog and continue chain
